...
!(function (t, e) {
  ...
  var c,
    ...
    H = function (t, e) {
      return arguments.length < 2 ? B(f[t]) : f[t] && f[t][e];
    },
    D = A({}.isPrototypeOf),
    ...
    z = V && V.v8;
  z && (u = (c = z.split("."))[0] > 0 && c[0] < 4 ? 1 : +(c[0] + c[1])),
    !u &&
      F &&
      (!(c = F.match(/Edge\/(\d+)/)) || c[1] >= 74) &&
      (c = F.match(/Chrome\/(\d+)/)) &&
      (u = +c[1]);
  var U = u,
    W =
    ...
    tt = function (t) {
      if (M(t)) return t;
      throw Z(Q(t) + " is not a function");
    },
    et = function (t, e) {
      var n = t[e];
      return null == n ? void 0 : tt(n);
    },
    nt = f.TypeError,
    it = Object.defineProperty,
    ot = function (t, e) {
      try {
        it(f, t, { value: e, configurable: !0, writable: !0 });
      } catch (n) {
        f[t] = e;
      }
      return e;
    ...
    dt = A((1).toString),
    gt = function (t) {
      return "Symbol(" + (void 0 === t ? "" : t) + ")_" + dt(++ft + pt, 36);
    },
    vt = st("wks"),
    mt = f.Symbol,
    bt = mt && mt.for,
    ...
    wt = function (t) {
      if (!ht(vt, t) || (!W && "string" != typeof vt[t])) {
        var e = "Symbol." + t;
        W && ht(mt, t) ? (vt[t] = mt[t]) : (vt[t] = K && bt ? bt(e) : yt(e));
      }
      return vt[t];
    },
    _t = f.TypeError,
    ...
    xt = function (t, e) {
      ...
      var n,
        i = et(t, St);
      if (i) {
        if ((void 0 === e && (e = "default"), (n = m(i, t, e)), !q(n) || X(n)))
          return n;
      ...
      return (
        ...
        (function (t, e) {
          var n, i;
          if ("string" === e && M((n = t.toString)) && !q((i = m(n, t))))
            return i;
          if (M((n = t.valueOf)) && !q((i = m(n, t)))) return i;
          if ("string" !== e && M((n = t.toString)) && !q((i = m(n, t))))
            return i;
    ...
    Pt = function (t) {
      if (q(t)) return t;
      throw Ot(Lt(t) + " is not an object");
    },
    Rt = f.TypeError,
          ...
          ? function (t, e, n) {
              if (
                ...
                i &&
                  ...
                  ((t[e] = n.value),
                  (n = {
                    configurable: Ht in n ? n.configurable : i.configurable,
                    enumerable: Bt in n ? n.enumerable : i.enumerable,
                    writable: !1,
                  }));
              }
              return Mt(t, e, n);
  ...
  var Vt,
    ...
    ee = f.WeakMap;
  if (Yt || at.state) {
    var ne = at.state || (at.state = new ee()),
      ie = A(ne.get),
      oe = A(ne.has),
      re = A(ne.set);
    (Vt = function (t, e) {
      if (oe(ne, t)) throw new te(Zt);
      return (e.facade = t), re(ne, t, e), e;
    }),
      (zt = function (t) {
        return ie(ne, t) || {};
      }),
    ...
    (Qt[ae] = !0),
      (Vt = function (t, e) {
        if (ht(t, ae)) throw new te(Zt);
        return (e.facade = t), $t(t, ae, e), e;
      }),
      (zt = function (t) {
        return ht(t, ae) ? t[ae] : {};
      }),
  ...
  var se = {
      ...
      has: Ut,
      enforce: function (t) {
        return Ut(t) ? zt(t) : Vt(t, {});
      },
      getterFor: function (t) {
        return function (e) {
          var n;
          if (!q(e) || (n = zt(e)).type !== t)
    ...
    he = {
      EXISTS: ue,
      PROPER: ue && "something" === function () {}.name,
      CONFIGURABLE: ue && (!d || (d && ce(le, "name").configurable)),
    },
    fe = l(function (t) {
      var e = he.CONFIGURABLE,
        n = se.get,
        i = se.enforce,
      ...
      (t.exports = function (t, n, r, a) {
        ...
        M(r) &&
          ...
          (!ht(r, "name") || (e && r.name !== h)) && $t(r, "name", h),
          (s = i(r)).source ||
            (s.source = o.join("string" == typeof h ? h : ""))),
          t !== f
            ? (l ? !u && t[n] && (c = !0) : delete t[n],
              c ? (t[n] = r) : $t(t, n, r))
            : c
            ? (t[n] = r)
            : ot(n, r);
      })(Function.prototype, "toString", function () {
        return (M(this) && n(this).source) || Wt(this);
      });
    }),
    pe = Math.ceil,
    de = Math.floor,
    ge = function (t) {
      var e = +t;
      return e != e || 0 === e ? 0 : (e > 0 ? de : pe)(e);
    },
    ve = Math.max,
    me = Math.min,
    be = function (t, e) {
      var n = ge(t);
      return n < 0 ? ve(n + e, 0) : me(n, e);
    },
    ye = Math.min,
    we = function (t) {
    ...
    Ae = function (t, e) {
      var n,
        ...
        o = 0,
        r = [];
      for (n in i) !ht(Qt, n) && ht(i, n) && Ce(r, n);
      for (; e.length > o; ) ht(i, (n = e[o++])) && (~je(r, n) || Ce(r, n));
      return r;
    },
    ke = [
      "constructor",
    ...
    Oe = function (t, e, n) {
      for (var i = Le(e), o = Ft.f, r = It.f, a = 0; a < i.length; a++) {
        var s = i[a];
    ...
    $e = function (t, e) {
      var n,
        ...
        l = t.global,
        c = t.stat;
      if ((n = l ? f : c ? f[s] || ot(s, {}) : (f[s] || {}).prototype))
        for (i in e) {
          if (
            ((r = e[i]),
            (o = t.noTargetGet ? (a = Fe(n, i)) && a.value : n[i]),
            !De(l ? i : s + (c ? "." : "#") + i, t.forced) && void 0 !== o)
          ) {
            if (typeof r == typeof o) continue;
            Oe(r, o);
          }
          (t.sham || (o && o.sham)) && $t(r, "sham", !0), fe(n, i, r, t);
        }
    },
    Ge = {};
  Ge[wt("toStringTag")] = "z";
  var Ve,
    ze = "[object z]" === String(Ge),
    Ue = wt("toStringTag"),
    We = f.Object,
    Ke =
      "Arguments" ==
    ...
    rn =
      d && !Nt
        ...
        : function (t, e) {
            Pt(t);
            for (var n, i = R(e), o = on(e), r = o.length, a = 0; r > a; )
              Ft.f(t, (n = o[a++]), i[n]);
            return t;
          },
    an = { f: rn },
    ...
    fn = function () {
      ...
      fn =
        "undefined" != typeof document
          ? document.domain && Ve
            ? hn(Ve)
            : (((e = kt("iframe")).style.display = "none"),
              sn.appendChild(e),
              (e.src = String("javascript:")),
              (t = e.contentWindow.document).open(),
              t.write(un("document.F=Object")),
              t.close(),
              t.F)
          : hn(Ve);
      for (var n = ke.length; n--; ) delete fn.prototype[ke[n]];
      return fn();
    };
  Qt[ln] = !0;
  var pn,
      ...
      if (
        (p &&
          ...
          l.lastIndex > 0 &&
            ...
            ((g = "(?: " + g + ")"), (b = " " + b), v++),
          (n = new RegExp("^(?:" + g + ")", d))),
        In && (n = new RegExp("^" + g + "$(?!\\s)", d)),
        En && (i = l.lastIndex),
        (o = m(Sn, p ? n : l, b)),
        p
          ? o
            ? ((o.input = kn(o.input, v)),
              (o[0] = kn(o[0], v)),
              (o.index = l.lastIndex),
              (l.lastIndex += o[0].length))
            : (l.lastIndex = 0)
          : En && o && (l.lastIndex = l.global ? o.index + o[0].length : i),
        In &&
          o &&
          o.length > 1 &&
          m(_n, o[0], n, function () {
        ...
        for (o.groups = a = gn(null), r = 0; r < f.length; r++)
          a[(s = f[r])[0]] = o[s[1]];
      return o;
    });
  var Nn = xn;
  $e({ target: "RegExp", proto: !0, forced: /./.exec !== Nn }, { exec: Nn });
  var Ln = wt("species"),
    On = RegExp.prototype,
    Pn = function (t, e, n, i) {
      var o = wt(t),
      ...
      if (!r || !a || n) {
        var s = A(/./[o]),
          l = e(o, ""[t], function (t, e, n, i, o) {
            var a = A(t),
              l = e.exec;
            return l === Nn || l === On.exec
              ? r && !o
    ...
    $n = function (t, e) {
      ...
      if (M(n)) {
        var i = m(n, t, e);
        return null !== i && Pt(i), i;
      }
      if ("RegExp" === T(t)) return m(Nn, t, e);
      throw Fn("RegExp#exec called on incompatible receiver");
    };
  Pn("match", function (t, e, n) {
    return [
      function (e) {
        var n = P(this),
          i = null == e ? void 0 : et(e, t);
        return i ? m(i, e, n) : new RegExp(e)[t](Je(n));
      },
      function (t) {
        var i = Pt(this),
          o = Je(t),
        ...
        if (!i.global) return $n(i, o);
        var a = i.unicode;
        i.lastIndex = 0;
        for (var s, l = [], c = 0; null !== (s = $n(i, o)); ) {
          var u = Je(s[0]);
          (l[c] = u),
            "" === u && (i.lastIndex = Dn(o, we(i.lastIndex), a)),
            c++;
        }
        return 0 === c ? null : l;
      },
      ...
      concat: function (t) {
        ...
        for (e = -1, i = arguments.length; e < i; e++)
          if (hi((r = -1 === e ? a : arguments[e]))) {
            if (l + (o = _e(r)) > ai) throw li(si);
            for (n = 0; n < o; n++, l++) n in r && Vn(s, l, r[n]);
          } else {
            if (l >= ai) throw li(si);
            Vn(s, l++, r);
          }
  ...
  ze || fe(Object.prototype, "toString", fi, { unsafe: !0 });
  var pi = he.PROPER,
    di = "toString",
    gi = RegExp.prototype,
    vi = gi.toString,
    ...
    fe(
      ...
      function () {
        ...
        return (
          ...
          e +
          "/" +
          Je(void 0 === n && D(gi, t) && !("flags" in gi) ? mi(t) : n)
        );
      },
      { unsafe: !0 }
    );
  var wi = Function.prototype,
    ...
    xi =
      ...
      (g
        ? Si.bind(_i)
        : function () {
            return Si.apply(_i, arguments);
          }),
    ji = wt("match"),
    Ci = function (t) {
      var e;
      return q(t) && (void 0 !== (e = t[ji]) ? !!e : "RegExp" == T(t));
    },
    Ai = f.TypeError,
    ki = wt("species"),
    Ei = function (t, e) {
      var n,
        i = Pt(t).constructor;
      return void 0 === i || null == (n = Pt(i)[ki])
        ? e
        : (function (t) {
            if (Zn(t)) return t;
            throw Ai(Q(t) + " is not a constructor");
          })(n);
    },
    Ti = f.Array,
    Ii = Math.max,
            ...
            ? function (t, n) {
                ...
                for (
                  ...
                  !(
                    (a = h.lastIndex) > u &&
                    (qi(l, Bi(i, u, r.index)),
                    r.length > 1 && r.index < i.length && xi(Ri, l, Ni(r, 1)),
                    (s = r[0].length),
                    (u = a),
                    l.length >= o)
                  );
                ...
                return (
                  u === i.length
                    ? (!s && Mi(h, "")) || qi(l, "")
                    : qi(l, Bi(i, u)),
                  l.length > o ? Ni(l, 0, o) : l
                );
              }
            : "0".split(void 0, 0).length
            ? function (t, n) {
                return void 0 === t && 0 === n ? [] : m(e, this, t, n);
              }
            : e),
        [
          function (e, n) {
            var o = P(this),
              r = null == e ? void 0 : et(e, t);
            return r ? m(r, e, o, n) : m(i, Je(o), e, n);
          },
          function (t, o) {
            var r = Pt(this),
              a = Je(t),
            ...
            var l = Ei(r, RegExp),
              ...
              f = void 0 === o ? Oi : o >>> 0;
            if (0 === f) return [];
            if (0 === a.length) return null === $n(h, a) ? [a] : [];
            for (var p = 0, d = 0, g = []; d < a.length; ) {
              ...
              if (
                null === m ||
                (v = Pi(we(h.lastIndex + (Li ? d : 0)), a.length)) === p
              )
                d = Dn(a, d, c);
              else {
                if ((qi(g, Bi(a, p, d)), g.length === f)) return g;
                for (var b = 1; b <= m.length - 1; b++)
                  if ((qi(g, m[b]), g.length === f)) return g;
                d = p = v;
              }
            }
            return qi(g, Bi(a, p)), g;
          },
        ]
      );
    },
    ...
    Yi =
      ...
      p(function () {
            ...
            Ui(
              ...
              Ui(
                Wi({}, "a", {
                  enumerable: !0,
                  get: function () {
                    Wi(this, "b", { value: 3, enumerable: !1 });
                  },
                }),
                { b: 2 }
              )
        ...
        return (
          ...
          7 != Ui({}, t)[n] || on(Ui({}, e)).join("") != i
        );
      })
        ? function (t, e) {
            for (
              var n = ct(t), i = arguments.length, o = 1, r = Ie.f, a = w.f;
              i > o;
              ...
              for (
                var s,
                  l = L(arguments[o++]),
                  c = r ? Ki(on(l), r(l)) : on(l),
                  u = c.length,
                  h = 0;
                u > h;

              )
                (s = c[h++]), (d && !m(a, l, s)) || (n[s] = l[s]);
            return n;
          }
        : Ui;
  function Xi(t) {
    var e = t.parentNode;
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === Fi(t, "position") || Xi(e))
    );
  }
  function Ji(t, e) {
    var n = document.body,
  ...
  $e(
    { target: "Object", stat: !0, forced: Object.assign !== Yi },
    { assign: Yi }
  );
  var Qi = Math.floor,
    Zi = A("".charAt),
    ...
    no = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
    io = /\$([$&'`]|\d{1,2})/g,
    oo = function (t, e, n, i, o, r) {
      var a = n + t.length,
        s = i.length,
        l = io;
      return (
        void 0 !== o && ((o = ct(o)), (l = no)),
        to(r, l, function (r, l) {
          var c;
          switch (Zi(l, 0)) {
            case "$":
  ...
  function mo(t) {
    if (t) {
      ...
      Xi(e.element)
        ? Di(t, "introjs-fixedTooltip")
        : go(t, "introjs-fixedTooltip"),
  ...
  Pn(
    ...
    function (t, e, n) {
      ...
      return [
        function (t, n) {
          var i = P(this),
            o = null == t ? void 0 : et(t, ro);
          return o ? m(o, t, i, n) : m(e, Je(i), t, n);
        },
        function (t, o) {
          var r = Pt(this),
            a = Je(t);
          if ("string" == typeof o && -1 === uo(o, i) && -1 === uo(o, "$<")) {
            var s = n(e, r, a, o);
            if (s.done) return s.value;
          }
          var l = M(o);
          ...
          for (var h = []; ; ) {
            ...
            if (null === f) break;
            if ((co(h, f), !c)) break;
            "" === Je(f[0]) && (r.lastIndex = Dn(a, we(r.lastIndex), u));
          }
          for (var p, d = "", g = 0, v = 0; v < h.length; v++) {
            for (
              var m = Je((f = h[v])[0]),
                b = ao(so(ge(f.index), a.length), 0),
                y = [],
                w = 1;
              w < f.length;
              w++
            )
              co(y, void 0 === (p = f[w]) ? p : String(p));
            var _ = f.groups;
            if (l) {
              var S = lo([m], y, b, a);
              void 0 !== _ && co(S, _);
              var x = Je(xi(o, void 0, S));
            } else x = oo(m, a, b, y, _, o);
            b >= g && ((d += ho(a, g, b) + x), (g = b + m.length));
          }
          return d + ho(a, g);
        },
      ];
  ...
  var bo = wt("unscopables"),
    yo = Array.prototype;
  null == yo[bo] && Ft.f(yo, bo, { configurable: !0, value: gn(null) });
  var wo,
    _o = xe.includes;
  $e(
    ...
    { target: "Array", proto: !0, forced: !xo },
    {
      slice: function (t, e) {
        ...
        if (
          ...
          return So(r, s, l);
        for (
          i = new (void 0 === n ? Co : n)(Ao(l - s, 0)), o = 0;
          s < l;
          s++, o++
        )
          s in r && Vn(i, o, r[s]);
  ...
  var ko = f.TypeError,
    Eo = function (t) {
      if (Ci(t)) throw ko("The method doesn't accept regular expressions");
      return t;
    },
    To = wt("match"),
    Io = A("".indexOf);
  ...
  var No = function (t, e) {
    ...
    Po = No("join", ",");
  $e(
    { target: "Array", proto: !0, forced: Oo || !Po },
    {
      join: function (t) {
        return Lo(R(this), void 0 === t ? "," : t);
      },
    }
  );
  var Ro = A(A.bind),
  ...
  $e(
    { target: "Array", proto: !0, forced: !oi("filter") },
    {
      filter: function (t) {
  ...
  function Yo(t, e, n) {
    var i = this._options.positionPrecedence.slice(),
      ...
      l = "floating";
    s.bottom + r > o.height && Ko(i, "bottom"),
      s.top - r < 0 && Ko(i, "top"),
      s.right + a > o.width && Ko(i, "right"),
      s.left - a < 0 && Ko(i, "left");
    var c,
      u,
    ...
    return (
      ...
      ["top", "bottom"].includes(l) &&
        (l += (function (t, e, n, i) {
          ...
          return (
            a - t < e && Ko(s, "-left-aligned"),
            (t < r || a - t < r) && Ko(s, "-middle-aligned"),
            t < e && Ko(s, "-right-aligned"),
            s.length ? (s.includes(i) ? i : s[0]) : "-middle-aligned"
          );
        })(s.left, a, o, h)),
      l
    );
    ...
    if (
      ...
      switch (
        ...
        "floating" !== (l = this._introItems[this._currentStep].position) &&
          ...
          (l = Yo.call(this, t, e, l)),
        (a = Ji(t)),
        (r = Ji(e)),
        (s = Gi()),
        Di(e, "introjs-".concat(l)),
        l)
      ) {
        case "top-right-aligned":
          n.className = "introjs-arrow bottom-right";
          var u = 0;
          Fo(a, u, r, e), (e.style.bottom = "".concat(a.height + 20, "px"));
          break;
        case "top-middle-aligned":
          n.className = "introjs-arrow bottom-middle";
          var h = a.width / 2 - r.width / 2;
          i && (h += 5),
            Fo(a, h, r, e) && ((e.style.right = null), Do(a, h, r, s, e)),
  ...
  function Qo(t, e) {
    ...
    for (var o in e) {
      var r = e[o];
      "style" === o ? vo(n, r) : o.match(i) ? n.setAttribute(o, r) : (n[o] = r);
    }
    return n;
  }
  function Zo(t, e, n) {
  ...
  function nr(t) {
    var e = this,
      n = Qo("div", { className: "introjs-bullets" });
    ...
    return (
      r(this._introItems, function (e, n) {
        var r = e.step,
          a = Qo("li"),
          s = Qo("a");
        a.setAttribute("role", "presentation"),
          ...
          zi(s),
          (s.innerHTML = "&nbsp;"),
          s.setAttribute("data-step-number", r),
          a.appendChild(s),
          i.appendChild(a);
      }),
      n.appendChild(i),
  ...
  function rr() {
    ...
    return (
      ...
      e.setAttribute("aria-valuenow", tr.call(this)),
      (e.style.cssText = "width:".concat(tr.call(this), "%;")),
      t.appendChild(e),
      t
    );
  }
  function ar(t) {
    (t.querySelector(".introjs-progress .introjs-progressbar").style.cssText =
      "width:".concat(tr.call(this), "%;")),
      t
        .querySelector(".introjs-progress .introjs-progressbar")
        .setAttribute("aria-valuenow", tr.call(this));
  }
  function sr(t) {
    var e = this;
    ...
    if (
      ...
      var c = s.querySelector(".introjs-helperNumberLayer"),
      ...
      (o = s.querySelector(".introjs-skipbutton")),
        (i = s.querySelector(".introjs-prevbutton")),
        (n = s.querySelector(".introjs-nextbutton")),
        (a.className = l),
        (p.style.opacity = 0),
        ...
        (r._lastShowElementTimer = window.setTimeout(function () {
          null !== c &&
            ...
            ((null != n && /introjs-donebutton/gi.test(n.className)) ||
              null != n) &&
              n.focus(),
            Vi.call(r, t.scrollTo, t, u);
        }, 350));
    } else {
      var d = Qo("div", { className: l }),
      ...
      if (
        ...
        mo.call(r, d),
        mo.call(r, g),
        Zo(this._targetElement, d, !0),
        Zo(this._targetElement, g),
        (b.innerHTML = t.intro),
        (w.innerHTML = t.title),
        ...
        var S = Qo("div", { className: "introjs-dontShowAgain" }),
          x = Qo("input", {
            type: "checkbox",
        ...
        x.onchange = function (t) {
          e.setDontShowAgain(t.target.checked);
        };
        var j = Qo("label", { htmlFor: "introjs-dontShowAgain" });
        (j.innerText = this._options.dontShowAgainLabel),
          S.appendChild(x),
          S.appendChild(j),
          m.appendChild(S);
      }
      m.appendChild(nr.call(this, t)), m.appendChild(rr.call(this));
      var C = Qo("div");
      !0 === this._options.showStepNumbers &&
        ((C.className = "introjs-helperNumberLayer"),
        (C.innerHTML = ""
          .concat(t.step, " ")
        ...
        _.appendChild(n),
        m.appendChild(_),
        Xo.call(r, t.element, m, v),
        Vi.call(this, t.scrollTo, t, m);
    }
    var A = r._targetElement.querySelector(".introjs-disableInteraction");
    A && A.parentNode.removeChild(A),
      t.disableInteraction && er.call(r),
        ...
        ? (null != n &&
          ...
          !0 === this._options.hidePrev
            ? (null != i &&
              ...
              null != n && Di(n, "introjs-fullbutton"))
            : null != i &&
              (i.className = "".concat(
                this._options.buttonClass,
        ...
        ? (null != i &&
          ...
          !0 === this._options.hideNext
            ? (null != n &&
              ...
              null != i && Di(i, "introjs-fullbutton"))
            : null != n &&
      ...
      (function (t) {
        var e = t.element;
        Di(e, "introjs-showElement");
        var n = Fi(e, "position");
        "absolute" !== n &&
          "relative" !== n &&
          "sticky" !== n &&
          "fixed" !== n &&
          Di(e, "introjs-relativePosition");
      })(t),
      void 0 !== this._introAfterChangeCallback &&
        this._introAfterChangeCallback.call(this, t.element);
  }
  function lr(t) {
    (this._currentStep = t - 2), void 0 !== this._introItems && ur.call(this);
  }
  function cr(t) {
    (this._currentStepNumber = t), void 0 !== this._introItems && ur.call(this);
  }
  function ur() {
    var t = this;
    ...
    return (
      ...
      !1 === n
        ...
        ? ("function" == typeof this._introCompleteCallback &&
          ...
          void Yr.call(this, this._targetElement))
        : void sr.call(this, e)
    );
  }
  function hr() {
  ...
  function pr(t) {
    ...
    if (
      ...
      if ("ArrowLeft" === e || 37 === e) hr.call(this);
        ...
        n && n.className.match("introjs-prevbutton")
          ...
          ? (this._introItems.length - 1 === this._currentStep &&
            ...
            Yr.call(this, this._targetElement))
          : n && n.getAttribute("data-step-number")
          ? n.click()
          : ur.call(this),
          t.preventDefault ? t.preventDefault() : (t.returnValue = !1);
      }
    } else Yr.call(this, this._targetElement);
  }
  function dr(e) {
  ...
  function vr(t) {
    var e = gr('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    Cr.call(this),
      e && Di(e, "introjs-hidehint"),
      void 0 !== this._hintCloseCallback &&
        this._hintCloseCallback.call(this, t);
  }
  function mr() {
    var t = this;
    r(gr(".introjs-hint"), function (e) {
      vr.call(t, e.getAttribute("data-step"));
    });
  }
  function br() {
    var t = this,
    ...
    e && e.length
      ? r(e, function (e) {
          yr.call(t, e.getAttribute("data-step"));
        })
      : Ar.call(this, this._targetElement);
  }
  function yr(t) {
    var e = gr('.introjs-hint[data-step="'.concat(t, '"]'))[0];
  ...
  function wr() {
    var t = this;
    r(gr(".introjs-hint"), function (e) {
      _r.call(t, e.getAttribute("data-step"));
    }),
      a.off(document, "click", Cr, this, !1),
      a.off(window, "resize", kr, this, !0),
  ...
  function Sr() {
    ...
    r(this._introItems, function (i, o) {
      if (
        ...
        zi(r),
          ...
          i.hintAnimation || Di(r, "introjs-hint-no-anim"),
          Xi(i.element) && Di(r, "introjs-fixedhint");
        ...
        r.appendChild(a),
          ...
          (i.element = r),
          xr.call(t, i.hintPosition, r, i.targetElement),
          n.appendChild(r);
      }
    }),
  ...
  function Ar(t) {
    ...
    if (((this._introItems = []), this._options.hints))
      r(this._options.hints, function (t) {
        var n = dr(t);
      ...
      r(n, function (t) {
        var n = t.getAttribute("data-hint-animation");
        (n = n ? "true" === n : e._options.hintAnimation),
          e._introItems.push({
            element: t,
            hint: t.getAttribute("data-hint"),
            hintPosition:
              t.getAttribute("data-hint-position") || e._options.hintPosition,
            hintAnimation: n,
    ...
    Sr.call(this),
      a.on(document, "click", Cr, this, !1),
      a.on(window, "resize", kr, this, !0);
  }
  function kr() {
    var t = this;
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === h
            ...
            : 1 === h
            ? ((n = 0), (i = c - u))
            : ((n = h - 2), (i = zo(Vo(ge(e), 0), c - u))),
          c + n - i > Uo)
        )
          throw Go(Wo);
        for (o = ni(l, i), r = 0; r < i; r++)
          (a = u + r) in l && Vn(o, r, l[a]);
        if (((o.length = i), n < i)) {
          for (r = u; r < c - i; r++)
            (s = r + n), (a = r + i) in l ? (l[s] = l[a]) : delete l[s];
          for (r = c; r > c - i + n; r--) delete l[r - 1];
        } else if (n > i)
          for (r = c - i; r > u; r--)
            (s = r + n - 1), (a = r + i - 1) in l ? (l[s] = l[a]) : delete l[s];
  ...
  var Er = Math.floor,
    Tr = function (t, e) {
      var n = t.length,
        i = Er(n / 2);
      return n < 8 ? Ir(t, e) : Nr(t, Tr(Ni(t, 0, i), e), Tr(Ni(t, i), e), e);
    },
    Ir = function (t, e) {
    ...
    Nr = function (t, e, n, i) {
      for (var o = e.length, r = n.length, a = 0, s = 0; a < o || s < r; )
        t[a + s] =
          a < o && s < r
            ? i(e[a], n[s]) <= 0
              ? e[a++]
    ...
    Vr = !p(function () {
      ...
      if (!(Pr && Pr > 3)) {
        ...
        for (t = 65; t < 76; t++) {
          ...
          for (i = 0; i < 47; i++) Br.push({ k: e + i, v: n });
        }
        for (
          ...
          (e = Br[i].k.charAt(0)), o.charAt(o.length - 1) !== e && (o += e);
  ...
  function zr(t) {
    ...
    if (this._options.steps)
      r(this._options.steps, function (t) {
        var n = dr(t);
        if (
          ((n.step = i.length + 1),
          (n.title = n.title || ""),
          ...
          null === o &&
            ((o = Qo("div", { className: "introjsFloatingElement" })),
    ...
    for (var s = [], l = 0; l < i.length; l++) i[l] && s.push(i[l]);
    return (
  ...
  function Ur(t) {
    ...
    if (
      ...
      mo.call(this, i),
      t &&
        ((this._introItems = zr.call(this, this._targetElement)),
        ir.call(this, e, this._introItems[this._currentStep]),
        ar.call(this, e)),
      ...
      r &&
        o &&
        Xo.call(this, this._introItems[this._currentStep].element, r, o);
    }
    return kr.call(this), this;
  }
  function Wr() {
    Ur.call(this);
  }
  ...
  function Yr(t, e) {
    ...
    if (
      ...
      i &&
        ...
        Kr(t.querySelector(".introjs-helperLayer"), !0),
        Kr(t.querySelector(".introjs-tooltipReferenceLayer")),
        Kr(t.querySelector(".introjs-disableInteraction")),
        Kr(document.querySelector(".introjsFloatingElement")),
        Jo(),
        a.off(window, "keydown", pr, this, !0),
        a.off(window, "resize", Wr, this, !0),
  ...
  function Xr(t) {
    ...
    return (
      vo(n, { top: 0, bottom: 0, left: 0, right: 0, position: "fixed" }),
      t.appendChild(n),
        ...
        0 === e.length ||
          ...
          Xr.call(this, t) &&
            ...
            this._options.keyboardNavigation &&
              a.on(window, "keydown", pr, this, !0),
            a.on(window, "resize", Wr, this, !0))),
        !1
      );
    }
  }
  $e(
    { target: "Array", proto: !0, forced: Fr || !$r || !Gr || !Vr },
    {
      sort: function (t) {
        void 0 !== t && tt(t);
        var e = ct(this);
        if (Vr) return void 0 === t ? Hr(e) : Hr(e, t);
        var n,
          i,
          o = [],
          r = _e(e);
        for (i = 0; i < r; i++) i in e && Dr(o, e[i]);
        for (
          Lr(
            o,
            (function (t) {
  ...
  for (var ra in Qr) Qr[ra] && oa(f[ra] && f[ra].prototype);
  oa(ea);
  var aa,
    sa = "\t\n\v\f\r                　\u2028\u2029\ufeff",
    la = A("".replace),
    ...
    fa = function (t) {
      return function (e) {
        var n = Je(P(e));
        return 1 & t && (n = la(n, ua, "")), 2 & t && (n = la(n, ha, "")), n;
      };
    },
  ...
  function va(t, n, i) {
    ...
    var s = [];
    for (var l in r) s.push("".concat(l, "=").concat(r[l]));
    return (document.cookie = s.join("; ")), ma(t);
  }
  function ma(t) {
    return ((e = {}),
  ...
  function ya(t) {
    t
      ...
      : va(this._options.dontShowAgainCookie, "", -1);
  }
  function wa() {
    var t = ma(this._options.dontShowAgainCookie);
    return t && t === ba;
  }
  function _a(t) {
  ...
  var Sa = function e(n) {
    var i;
    if ("object" === t(n)) i = new _a(n);
    else if ("string" == typeof n) {
      var r = document.querySelector(n);
      if (!r) throw new Error("There is no element with given selector.");
      i = new _a(r);
    } else i = new _a(document.body);
    return (e.instances[o(i, "introjs-instance")] = i), i;
  };
  return (
    (Sa.version = "5.1.0"),
    (Sa.instances = {}),
    (Sa.fn = _a.prototype =
      {
        isActive: function () {
          return (
            (!this._options.dontShowAgain || !wa.call(this)) &&
        ...
        start: function () {
          return Jr.call(this, this._targetElement), this;
        },
        goToStep: function (t) {
          return lr.call(this, t), this;
        },
        addStep: function (t) {
          return (
        ...
        exit: function (t) {
          return Yr.call(this, this._targetElement, t), this;
        },
        refresh: function (t) {
          return Ur.call(this, t), this;
        },
        setDontShowAgain: function (t) {
          return ya.call(this, t), this;
        },
        ...
        addHints: function () {
          return Ar.call(this, this._targetElement), this;
        },
        hideHint: function (t) {
          return vr.call(this, t), this;
        },
        hideHints: function () {
          return mr.call(this), this;
        },
        showHint: function (t) {
          return yr.call(this, t), this;
        },
        showHints: function () {
          return br.call(this), this;
        },
        removeHints: function () {
          return wr.call(this), this;
        },
        removeHint: function (t) {
          return _r().call(this, t), this;
        },
        showHintDialog: function (t) {
          return jr.call(this, t), this;
        },
      }),
    Sa
  );
